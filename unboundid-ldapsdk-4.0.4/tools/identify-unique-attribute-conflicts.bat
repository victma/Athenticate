...
rem Copyright 2013-2018 Ping Identity Corporation
rem All Rights Reserved.
rem
rem -----
rem
rem Copyright (C) 2013-2018 Ping Identity Corporation
...
"%JAVA_CMD%" %JAVA_ARGS% -cp "%BATDIR%\..\unboundid-ldapsdk.jar;%CLASSPATH%" com.unboundid.ldap.sdk.examples.IdentifyUniqueAttributeConflicts %*
