...
rem -----
rem
rem Copyright (C) 2016-2018 Ping Identity Corporation
...
"%JAVA_CMD%" %JAVA_ARGS% -cp "%BATDIR%\..\unboundid-ldapsdk.jar" com.unboundid.ldap.sdk.unboundidds.RegisterYubiKeyOTPDevice %*
